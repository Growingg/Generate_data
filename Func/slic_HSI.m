...
%     figure(1);
%     subplot_tight(1, 1, 1,[.06 .03]); image(im_seg);axis image;axis off;
%     title('Segmentation','fontsize',8);  
%     figure(2);
%     subplot_tight(1, 1, 1,[.06 .03]); imagesc(Cj);axis off;axis image;
%     title('Confindence index','fontsize',8);   
%     drawnow;
